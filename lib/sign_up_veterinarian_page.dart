...
class _SignUpVeterinarianPageState extends State<SignUpVeterinarianPage> {
  ...
  final CollectionReference veterinaireCollection = FirebaseFirestore.instance.collection('veterinaire');
                ...
                onPressed: () async {
                  if (_passwordController.text == _confirmPasswordController.text) {
                    try {
                      ...
                      final String fullAddress = '${_addressController.text}, ${_cityController.text}';

                      // Add veterinarian data to Firestore
                      await veterinaireCollection.doc(userCredential.user!.uid).set({
